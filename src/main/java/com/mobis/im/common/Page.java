...
public class Page {
		...
		// list
		private List<ImUserViewVO> content;
		
		// 생성자
		// size : 한 화면에 보여질 행의 수
		public Page(int total, int currentPage, int size, int pagingCount, List<ImUserViewVO> content) {
			this.total = total;
		...
		// 데이터 VO List 리턴
		public List<ImUserViewVO> getContent(){
			return this.content;
		}
